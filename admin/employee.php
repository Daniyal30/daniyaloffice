        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title text-capitalize">employee table </h3>
            </div>
            <div class="row">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>$age</td>
                                        <td>$city</td>
                                        <td><img src='$image' alt='image not found' class='img-fluid' width='100px' height='100px'></td>
                                        <div class='d-block'>
                                        <td><a href='employee_edit.php?id=$id' class='nav-link'  type='button data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-title='Tooltip on bottom'><span class='text-secondary mdi mdi-grease-pencil fs-5'></span></a>
                                        <a href='employee_delete.php?id=$id' class='nav-link'><span class='text-danger mdi mdi-delete fs-5'></span></a>
                                        </td>
                                        </div>
                                        </tr>";
                                    }
