          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <div class="text-center text-capitalize text-gray-900 mb-4 ">
                <h4>edit emloyees</h4>
                </div>
                
                
                <form class="user" class="pt-3" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="text" name="age"value="<?php echo $row['age']?>" class="form-control form-control-lg"  placeholder="age">
                  </div>
                  <div class="form-group">
                    <input type="text" name="city" value="<?php echo $row['city']?>" class="form-control form-control-lg" placeholder="city">
                  </div>
                  ...
                  <div class="mt-3">
                    <button class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" name="update">UPDADE</button>
                  </div>
