...
if (isset($_POST['post'])) {
    ...
    $insert = "INSERT INTO `notice_board` (`title`, `posted_date`, `message`)
    VALUES('$title', '$posted_date', '$message')";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <h3 class="page-title text-capitalize">notification</h3>
            </div>
            <div class="row">
              <div class="text-end">
                <a href="notification.php" class="btn btn-primary btn-sm text-capitalize rounded mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">add notification</a>
              </div>
                      ...
                      <tbody>
                        ...
                        <?php
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>$title</td>   
                                        <td>$posted_date</td>
                                        <td><a href='notification.php?id=$id' class='btn btn-primary btn-sm'>view</a></td>
                                        </tr>";
                                    }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5 text-capitalize" id="exampleModalLabel">type notification</h1>
      ...
      <form class="user" method="post">
               ...
               <div class="form-group">
                 <input type="date" name=" posted_date" class="form-control form-control-lg"  
