...
if (isset($_POST['submit'])) {
  ...
  $insert = "INSERT INTO `task` (`task_title`, `task_descripttion`,`start_date`, `end_date`, `assign_to`)
  VALUES('$task_tittle',' $task_description', '$posted_date', '$deadline', '$assign_to')";
              ...
              <h4> task</h4>
                ...
                <form class="user" method="post">
                  <div class="form-group">
                    <input type="text" name="task_tittle" class="form-control form-control-lg" id="exampleInputname1" placeholder="task tittle">
                  </div>
                  <div class="form-group">
                    <textarea name="task_description" class="form-control form-control-lg" id="exampleInputtaskdescription" placeholder=" task description" cols="70" rows="10"></textarea>
