        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <h2 class="text-capitalize card-title">show task</h2>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php
                                    ...
                                    $select = "SELECT * FROM `task` WHERE `assign_to` ='".$_SESSION['name']['name']."'";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td>$deadline</td>
                                        <td>$message</td>
                                        <td><a href='show_task.php?id=$id'><i class='mdi mdi-eye menu-icon fs-5'></i></a></td>
